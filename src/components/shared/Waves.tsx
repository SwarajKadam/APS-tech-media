...
export default function Waves({
  ...
  useEffect(() => {
    ...
    function drawLines() {
        ...
        const gradient = ctx.createLinearGradient(0, 0, width, height); // Create a gradient
        gradient.addColorStop(0, "#0000FF"); // Start color
        gradient.addColorStop(1, "#FF00FF"); // End color
